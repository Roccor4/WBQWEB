  ...
  return (
    ...
    >
                      ...
                      <div className="md:flex gap-6">
                        ...
                        <div className="md:w-2/3 space-y-4">
                          ...
                          <a
                            ...
                            style={{
                              background:
                                'linear-gradient(to right, rgba(120,53,15,1), rgba(146,64,14,1))',
                              color: '#F3E8C7',
                              border: '1px solid rgba(120,53,15,0.5)'
                            }}
                          >
                          ...
                          {item.id === 'doctrines' && (
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                              <div className="group">
                                ...
                                <h5 className="mb-2" style={{ color: '#F5E6B8' }}>
                                  {item.title}
                                </h5>
                                <p className="mb-4" style={{ color: 'rgba(245,230,184,0.8)' }}>
                                  {item.description}
                                </p>
                                <blockquote
      ...
      {selectedImage && (
        ...
        >
          <div
            className="relative w-full h-full max-w-none max-h-none overflow-auto rounded-lg"
