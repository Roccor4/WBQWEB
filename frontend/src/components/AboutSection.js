    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`text-center transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <h2 className="ceremonial-heading text-3xl md:text-4xl lg:text-5xl text-amber-100 mb-8">
            About the Book
          </h2>

          <div className="literary-text text-base md:text-lg text-amber-200/90 leading-relaxed space-y-6 max-w-3xl mx-auto">
            <p>
