      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="mb-8 flex justify-center">
          <img 
            ...
            className="order-emblem w-24 h-24 md:w-32 md:h-32 lg:w-40 lg:h-40 candle-glow"
          />
        </div>

        {/* Main Headline */}
        <h1 className="ceremonial-heading text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-amber-100 mb-6 leading-tight">
        ...
        <Button 
          ...
          className="oath-button bg-red-900 hover:bg-red-800 text-amber-100 text-lg md:text-xl px-8 md:px-12 py-4 md:py-6 rounded-md font-semibold tracking-wide shadow-lg transform hover:scale-105 transition-all duration-300"
          size="lg"
        >
          Swear the Oath
        </Button>
