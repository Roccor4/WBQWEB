  ...
  const charactersData = [
    {
      ...
      lore: `Seventeen years old when his mother signed him away, Luca Altomare entered the gates of the Ordo Solis carrying a name already heavy with shame. The son of a vanished father with fascist ties and a mother who retreated into silence, he arrives in the Dolomite compound as a Lamb—stripped of his past, bound to obedience, and watched by a world that speaks only in ritual. Intelligent, reserved, and quietly defiant, Luca navigates the Order's brutal hierarchy of Vessels, Instruments, and Ascendants under the gaze of the Four Pillars. In the beginning, survival means learning the rules; later, it means deciding which part of himself he can afford to keep. Through cold corridors, orchestrated silences, and moments of forbidden connection, Luca becomes both subject and witness to the unmaking of boys into instruments of power—while wrestling with the question of whether obedience will save him, or destroy him.`
    },
    {
      id: 'leandro',
      name: 'Leandro',
      image: 'https://customer-assets.emergentagent.com/job_60806795-f832-4de7-acd6-95f75d4caccc/artifacts/igpzfhsa_Leandro.png',
      lore: `Once a defiant street fighter with nothing to lose, Leandro has been forged by the Ordo Solis into a Vessel—responsible for shaping and controlling a younger boy, a Lamb. He moves with the calm precision of someone who knows every rule by heart, wearing obedience like a second skin. To Luca Altomare, he is both warden and lifeline: the one who teaches him how to survive the Order's rituals, and the one whose silences wound deeper than any punishment. Beneath his disciplined exterior lies a boy tempered by loss, his youth spent in the custody of those who value loyalty over love. Whether his quiet acts of care are rebellion or simply another form of obedience is a question Luca cannot answer—only that in the cold halls of the Order, he walks in Leandro's shadow, and somehow, that feels safer than walking alone.`
    },
    {
      id: 'cassian',
      name: 'Cassian',
