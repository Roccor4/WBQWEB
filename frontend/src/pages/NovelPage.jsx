­r‡^Ñf¥–Ø¦{N,yÊ'vÃ®¶›­import { ReleaseActions, usePageMeta } from '../components/SiteChrome';
...
const earlyReaderNotes = [
  ...
  { key: 'luca', lines: ['Lucaâ€™s voice feels', 'consistent and lived-in,', 'and his emotional journey carries the weight of the story from beginning to end.'] },
  { key: 'world', lines: ['It is a world that feels', 'ancient and predatory', 'before anyone even does anything threatening. Thatâ€™s hard to pull off.'] },
